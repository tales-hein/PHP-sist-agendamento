<script>
    ...
    // Validação na página de login no onblur
    ...
    function validarEmail(){
        ...
        if (valido == false) {
            $("#container-email").append("<p style='color:#dc3545;font-size:14px'> <i class='fa fa-circle-xmark'></i>&ensp;Digite um e-mail válido</p>");
    ...
    function validarSenha(){
        ...
        //Mostrar erro ao usuário 
        if (valido == false) {
            $("#container-senha").append("<p style='color:#dc3545;font-size:14px'> <i class='fa fa-circle-xmark'></i>&ensp;Digite uma senha válida</p>");
    ...
    // Validação do formulário em submit
    ...
    function validaCadastroNome(nome) {
        ...
        //Mostrar erro ao usuário 
        if (valido == false) {
            $("#container-nome").append("<p style='color:#dc3545;font-size:14px'> <i class='fa fa-circle-xmark'></i>&ensp;Digite um nome válido</p>");
    ...
    function validaCadastroComparaSenha(senha, senhaConfirma) {
        ...
        //Mostrar erro ao usuário 
        if (valido == false) {
            $("#container-senha").append("<p style='color:#dc3545;font-size:14px'> <i class='fa fa-circle-xmark'></i>&ensp;  As senhas não são iguais</p>");
            $("#container-confirma-senha").append("<p style='color:#dc3545;font-size:14px'> <i class='fa fa-circle-xmark'></i>&ensp;  As senhas não são iguais</p>");
            $("[name='senha_confirma']").attr('class', 'form-control is-invalid');
            $("[name='senha']").attr('class', 'form-control is-invalid');
        };
    ...
    function validaCadastroTelefone(telefone) {
        ...
        //Mostrar erro ao usuário 
        if (valido == false) {
            $("#container-telefone").append("<p style='color:#dc3545;font-size:14px'> <i class='fa fa-circle-xmark'></i>&ensp;  Digite um telefone válido</p>");
    ...
    function validaCadastroCpf(cpf) {
        ...
        //Mostrar erro ao usuário 
        if (valido == false) {
            $("#container-cpf").append("<p style='color:#dc3545;font-size:14px'> <i class='fa fa-circle-xmark'></i>&ensp;  Digite um CPF válido</p>");
